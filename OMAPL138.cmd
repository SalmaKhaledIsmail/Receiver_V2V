...
SECTIONS
{
    .text          :>  DSPL2ROM   //code init
    .stack         >  SHRAM   //stack(local variables) init
    .bss           >  SHRAM   //global and static variables uninit
    .cio           >  SHRAM   //buffers for stdio functions uninit
    .const         >  DSPL2ROM    //Global and static string literals init
    .data          >  SHRAM   //
    .switch        > DSPL2ROM    // table for switch instructions init
    .sysmem        >  SHDSPL2ROM  //memory for malloc functions(heap) uninit
    .far           >  SHRAM
    .args          >  SHRAM
    .ppinfo        >  SHRAM
    .ppdata        >  SHRAM
